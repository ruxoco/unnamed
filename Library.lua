...
do
    ...
    Library.TopNotificationArea = Library:Create("Frame", {
        AnchorPoint = Vector2.new(0.5, 0);
        BackgroundTransparency = 1;
    ...
    Library:Create("UIListLayout", {
        ...
        SortOrder = Enum.SortOrder.LayoutOrder;
        Parent = Library.TopNotificationArea;
    })
    ...
    function Library:Notify(...)
        ...
        local isCentered = (Side == "top" or Side == "bottom")
        local XSize, YSize = Library:GetTextBounds(Data.Description, Library.Font, 14)
        YSize = YSize + 7

        local NotifyArea
        if Side == "left" then NotifyArea = Library.LeftNotificationArea
        elseif Side == "right" then NotifyArea = Library.RightNotificationArea
        elseif Side == "top" then NotifyArea = Library.TopNotificationArea
        elseif Side == "bottom" then NotifyArea = Library.BottomNotificationArea
        else NotifyArea = Library.LeftNotificationArea end
        ...
        local ExtraWidth = 0
        local TextPosition = isCentered and UDim2.new(0, 4, 0, 0)
            or (Side == "left" and UDim2.new(0, 4, 0, 0) or UDim2.new(1, -4, 0, 0))
        ...
        local NotifyLabel = Library:CreateLabel({
            ...
            TextXAlignment = isCentered and Enum.TextXAlignment.Center
                or (Side == "left" and Enum.TextXAlignment.Left or Enum.TextXAlignment.Right);
            TextSize = 14;
            ZIndex = 11003;
            RichText = true;
            Parent = InnerFrame;
        ...
        local SideColor = Library:Create("Frame", {
            AnchorPoint = isCentered
                and (Side == "top" and Vector2.new(0, 0) or Vector2.new(0, 1))
                or (Side == "left" and Vector2.new(0, 0) or Vector2.new(1, 0));
            Position = isCentered
                and (Side == "top" and UDim2.new(0, -1, 0, -1) or UDim2.new(0, -1, 1, 1))
